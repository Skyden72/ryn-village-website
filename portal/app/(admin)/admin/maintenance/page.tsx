...
const initialRequests = [
    { id: '1', title: 'Leaking tap in kitchen', resident: 'John Smith', unit: 'A12', category: 'Plumbing', status: 'pending', priority: 'normal', createdAt: '2026-01-20' },
    { id: '2', title: 'Light fixture not working', resident: 'Mary Johnson', unit: 'A15', category: 'Electrical', status: 'in_progress', priority: 'normal', createdAt: '2026-01-19' },
    { id: '3', title: 'AC not cooling', resident: 'Peter Williams', unit: 'B7', category: 'HVAC', status: 'pending', priority: 'urgent', createdAt: '2026-01-20' },
    { id: '4', title: 'Gate motor repair', resident: 'Susan Brown', unit: 'B12', category: 'General', status: 'resolved', priority: 'normal', createdAt: '2026-01-15' },
]
